...
// So we're testing if the words above appear in the string. Trying to filter out words that are not those 
// above.
...
Imagine you have written a story and used single quotation 
marks throughout to mark pieces of dialogue. Now you want to 
replace all the dialogue quotes with double quotes, while keeping 
...
that it is not necessary for there to be digits in front of or after the dot, but 
